...
export default function SideNavbar() {
    ...
    const roleNavItems = {
        ...
        carebuddy: [
            ...
            { href: '/carebuddy/leads', label: 'Leads', icon: UsersIcon, module: 'leads' },
            ...
            { href: '/carebuddy/hospitals', label: 'Hospitals', icon: Hospital, module: 'hospitals' },
            {
                label: 'Machines',
                icon: Package,
                module: 'machines',
        ...
        accountant: [
            ...
            { href: '/accountant/leads', label: 'Leads', icon: UsersIcon, module: 'leads' },
            { href: '/accountant/patients', label: 'Patients', icon: CircleUser, module: 'patients' },
            { href: '/accountant/pipeline', label: 'Pipeline', icon: FileText, module: 'pipeline' },
            { href: '/accountant/calendar', label: 'Calendar', icon: Calendar, module: 'calendar' },
            { href: '/accountant/hospitals', label: 'Hospitals', icon: Hospital, module: 'hospitals' },
            {
                label: 'Machines',
                icon: Package,
                module: 'machines',
                children: [
                    { href: '/accountant/machines', label: 'Inventory' },
                    { href: '/accountant/machines/showcase', label: 'Machine Showcase' }
                ]
            },
        ...
        outsourcing: [
            ...
            { href: '/outsourcing/patients', label: 'Patients', icon: CircleUser, module: 'patients' },
            { href: '/outsourcing/pipeline', label: 'Pipeline', icon: FileText, module: 'pipeline' },
            { href: '/outsourcing/calendar', label: 'Calendar', icon: Calendar, module: 'calendar' },
            { href: '/outsourcing/hospitals', label: 'Hospitals', icon: Hospital, module: 'hospitals' },
            {
                label: 'Machines',
                icon: Package,
                module: 'machines',
                children: [
                    { href: '/outsourcing/machines', label: 'Inventory' },
                    { href: '/outsourcing/machines/showcase', label: 'Machine Showcase' }
                ]
            },
