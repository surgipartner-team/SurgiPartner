...
export async function POST(request) {
    try {
        ...
        // machineId is optional and not strictly needed for Cloudinary filename generation in our helper
        // but we could use it if we wanted to customize the secure helper further. 
        // For now, the helper's sanitation is sufficient.
        ...
        const result = await uploadToCloudinary(file, 'machines');
